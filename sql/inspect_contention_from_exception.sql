...
contention AS (
  ...
  FROM crdb_internal.transaction_contention_events AS e, params
...
insights AS (
  ...
  FROM crdb_internal.cluster_execution_insights AS ci, params
...
FROM crdb_internal.statement_statistics AS st
